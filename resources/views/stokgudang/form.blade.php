      ...
      <form action="" method="post" class="form-horizontal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form group row">
                <label for="stok_gudang" class="col-md-3 col-md-offset-1 control-label">Jumlah Stok Masuk</label>
                <div class="col-md-8">
                    <input type="number" name="stok_gudang" class="form-control" required autofocus>
                    <span class="help-block with-errors"></span>
                </div>
              </div>
            </div>
